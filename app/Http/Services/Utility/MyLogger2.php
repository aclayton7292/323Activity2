...
class MyLogger2 implements ILogger
{
    ...
    static function getLogger(){
        if(self::$logger == null){
            ...
            $stream = new StreamHandler('storage/logs/myapp.logs');
    ...
    {
        self::getLogger()->debug($message,$data=array());
    }
    ...
    {
        self::getLogger()->error($message,$data=array());
        
    }

    public static function info($message, $data=array())
    {
        self::getLogger()->info($message,$data=array());
